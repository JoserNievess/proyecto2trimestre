...
<div class="relative w-full h-96 mt-24 rounded-xl overflow-hidden shadow-lg">
    ...
    <div class="mt-16 flex justify-center space-x-4">
        <a href="/" class="px-8 py-4 bg-yellow-500 text-white text-lg font-semibold rounded-xl shadow-lg hover:bg-yellow-600 transition duration-300 transform hover:scale-105">
            Inicio 
        </a>
        <a href="/blog" class="px-8 py-4 bg-yellow-500 text-white text-lg font-semibold rounded-xl shadow-lg hover:bg-yellow-600 transition duration-300 transform hover:scale-105">
        Saber más
        </a>
    </div>
</div>
